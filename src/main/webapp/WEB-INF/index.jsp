...
<div class="header">
    <div style="margin: 0 45% 0 45%;padding-top:5%;text-align:center;">
        <div style="height:16%;width:90%;background:black;text-align:center;">
            <h3 style="font-family: Menlo;color:white;padding-top:5%;"><strong>Yasha</strong></h3>
        </div>
        <h4 style="margin-top:16%;margin-left:-20%;">
            &nbsp;
            ...
            <label><a href="https://github.com/yasha1995">GitHub</a></label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <%--<label><a href="https://www.yasha1995.cn">Blog</a></label>--%>
            <label><a href="#">Blog</a></label>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <label><a href="#">ZhiHu</a></label>
